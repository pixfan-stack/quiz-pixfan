...
Document à jour avec l’état réel du dépôt (**v1.17.0**).
...
- [ ] **Lire Admin Analytics 7–14 j post v1.17.0** (habit funnel, modes, CTA) — checklist dans `vague-1-16` § P0.3 ; **ne pas inventer de chiffres**
